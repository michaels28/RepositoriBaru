...
@section('app_contents')
                                    ...
                                    <tbody>
                                        @foreach ($vaksin as $vaksin)
                                            <tr>
                                                ...
                                                <td>{{ $vaksin->created_at }}</td>
                                                <td>{{ $vaksin->jenis_vaksin }}</td>
                                                <td>
                                                    <button onclick="showGambar({{ $vaksin->id }})"
                                                        class="btn btn-sm btn-info" data-target="#modal-show-image"
    ...
    <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true" id="modal-show-image">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
