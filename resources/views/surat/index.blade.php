...
@section('app_contents')
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a
                        href="{{ Session::get('penduduk') ? url('penduduk') : url('admin/dashboard') }}">Dashboard</a></li>
            ...
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <div class="pull-right">
                        <a href="" class="btn btn-dark btn-sm" data-target="#modal-tambah-permohonan"
                            data-toggle="modal">Tambah Permohonan</a>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                                    ...
                                    <tbody>
                                        @foreach ($surat as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form
                                                        action="{{ url('penduduk/formulir/' . $item->tipe . '/' . $item->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('delete')
    ...
    <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-text="true" id="modal-tambah-permohonan">
                    ...
                    <form action="{{ url('penduduk/formulir') }}" method="post">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input required type="text" name="nama" value="{{ $penduduk->nama }}"
                                        class="form-control" readonly id="nama">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" hidden>
                                ...
                                <div class="col-sm-9">
                                    <input required name="nik" id="nik" value="{{ $penduduk->nik }}"
                                        class="form-control" type="text" maxlength="16" minlength="16">
                                </div>
                            </div>
                            <div class="form-group row" hidden>
                                ...
                                <div class="col-sm-5">
                                    <input required name="tempat_lahir" id="tempat_lahir"
                                        value="{{ $penduduk->tempat_lahir }}" class="form-control" type="text">
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group row" hidden>
                                ...
                                <div class="col-sm-9">
                                    <input required name="wn" id="wn"
                                        value="{{ $penduduk->kewarganegaraan }}" class="form-control" type="text">
                                </div>
                            </div>
                            <div class="form-group row" hidden>
