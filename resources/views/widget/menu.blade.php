    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                ...
                <li><a href="{{ url('formulir/lkp') }}" class="dropdown-item">Surat Keterangan Pengunjung/Pendatang</a>
                </li>
        ...
        <li class="nav-item">
            <a href="https://api.whatsapp.com/send?phone=6289660931433&text=Silahkan Isi Disini, jangan lupa sertakan nama Anda, sertakan Foto KTP dan isi Keperluan Anda, Kami akan Melayani. Trimakasih."
